    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Join MG Investments platform today!</Text>
        </View>
        ...
        <View style={styles.form}>
          <View style={styles.roleContainer}>
            ...
            <View style={styles.roleButtons}>
              ...
              <TouchableOpacity
                style={[styles.roleButton, role === 'school' && styles.activeRoleButton]}
                onPress={() => setRole('school')}
              >
                <Text style={[styles.roleButtonText, role === 'school' && styles.activeRoleButtonText]}>
                  School
                </Text>
              </TouchableOpacity>
            </View>
