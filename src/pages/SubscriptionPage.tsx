...
import { CheckCircle, Star, Smartphone, CreditCard, Phone, ArrowLeft, Briefcase, Users, MessageSquare, Bell, Filter, TrendingUp, Crown, Lock } from "lucide-react";
...
const SubscriptionPage = () => {
  ...
  // School-specific plans (original)
  const schoolPlans = [
    {
      name: "Basic Access",
      price: "50,000",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 flex items-center">
                {isFromTeacherPortal && <Crown className="h-6 w-6 mr-2 text-amber-500" />}
                {isFromTeacherPortal ? 'Unlock Premium Job Access' : 'Premium Subscription'}
              </h1>
            ...
            <Link to={isFromTeacherPortal ? "/teacher-portal" : "/"}>
              <Button variant="outline" size="sm">
                <ArrowLeft className="h-4 w-4 mr-2" />
                {isFromTeacherPortal ? 'Back to Portal' : 'Back to Home'}
              </Button>
            </Link>
          </div>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="text-center mb-12">
          <Badge className={`mb-4 ${isFromTeacherPortal ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800'} hover:bg-current`}>
            {isFromTeacherPortal ? (
              <>
