...
const RealTimeSchoolsDisplay: React.FC = () => {
  ...
  const schoolTypes = Array.from(new Set(schools.map(s => s.school_type)));
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{schools.filter(s => s.subscription_status === 'Premium').length}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {schools.reduce((sum, school) => sum + parseInt(school.total_teachers || '0'), 0)}
                </p>
              </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Badge className={getSubscriptionColor(school.subscription_status)}>
                          {getSubscriptionIcon(school.subscription_status)}
                    ...
                    <div className="flex items-center space-x-4 text-xs text-gray-500">
                      ...
                      <div className="flex items-center">
                        ...
                        Last Activity: {formatDate(school.last_activity)}
                      </div>
                    </div>
                  </div>
