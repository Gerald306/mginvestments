...
const DataApprovalWorkflow: React.FC = () => {
  ...
  const loadPendingApprovals = async () => {
    ...
    try {
      ...
      const mockApprovals: DataApprovalRequest[] = [
        {
          id: 'approval_1',
          type: 'teacher',
          data: {
            ...
            location: 'Kampala',
            bio: 'Experienced mathematics teacher with passion for student success.',
            hourly_rate: 25000,
        ...
        },
        {
          ...
          data: {
            ...
            school_type: 'Primary',
            location: 'Entebbe',
            contact_email: 'info@brightfuture.ug',
            phone_number: '+256702345678',
            website: 'www.brightfuture.ug',
      ...
      const filteredApprovals = filterType === 'all'
        ? mockApprovals
        : mockApprovals.filter(approval => approval.type === filterType);
