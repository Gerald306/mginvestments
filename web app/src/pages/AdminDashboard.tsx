            ...
            <div className="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <Link to="/" className="hover:opacity-80 transition-opacity duration-200 group">
                  <p className="text-xs sm:text-sm text-gray-700 font-medium hidden sm:block group-hover:text-orange-600 transition-colors duration-200">MG Investments - Teacher Management System</p>
                  <p className="text-xs text-gray-700 font-medium sm:hidden group-hover:text-orange-600 transition-colors duration-200">MG Investments</p>
                </Link>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
              ...
              <div className="hidden lg:flex items-center space-x-3">
                ...
                <Link to="/school-portal">
                  <Button variant="outline" className="border-purple-300 text-purple-700 hover:bg-purple-50 transition-all duration-300 hover:scale-105">
                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-64 bg-white/95 backdrop-blur-lg border border-orange-200/50 rounded-lg shadow-xl z-50">
                      <div className="p-3 space-y-2">
                        ...
                        <Link to="/school-portal" onClick={() => setIsActionsDropdownOpen(false)}>
                          <Button variant="outline" className="w-full justify-start text-sm py-3 border-purple-300 text-purple-700 hover:bg-purple-50">
                            <School className="h-4 w-4 mr-2" />
                            Schools Portal
                          </Button>
                        </Link>
        ...
        <div className="space-y-8">
          ...
          <div className="w-full">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 h-auto lg:h-14 bg-white/80 backdrop-blur-sm border border-orange-200/50 rounded-lg shadow-lg gap-1 sm:gap-2 p-1 sm:p-2">
                <TabsTrigger
                  value="overview"
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="space-y-2 pt-3 border-t">
                          ...
                          <Link to="/school-portal" className="block">
                            <Button className="w-full justify-start" variant="outline">
                              <School className="h-4 w-4 mr-2" />
                              Schools Portal Access
                            </Button>
                          </Link>
                          <Link to="/stats-demo" className="block">
                            <Button className="w-full justify-start" variant="outline">
                              <Activity className="h-4 w-4 mr-2" />
                              Real-Time Stats Demo
                            </Button>
                          </Link>
                        </div>
                      </CardContent>
